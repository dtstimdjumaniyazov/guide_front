...
const InstitutionsPage: React.FC = () => {
  ...
  const getSeoData = () => {
    if (filters.institution_type_id) {
      const seoMap: { [key: number]: { title: string; description: string } } = {
        1: {
          title: 'Детские сады Узбекистана - Каталог детских садов Ташкента 2025',
          description: 'Полный каталог детских садов Узбекистана. Найдите лучший детский сад в Ташкенте, Самарканде, Бухаре с описаниями, фото, ценами и отзывами родителей.',
        },
        2: {
          title: 'Школы Узбекистана - Каталог школ Ташкента 2025',
          description: 'Каталог государственных и частных школ Узбекистана. Выберите лучшую школу для вашего ребёнка в Ташкенте, Самарканде и других городах.',
        },
        3: {
          title: 'Кружки и секции для детей в Узбекистане - Каталог 2025',
          description: 'Детские кружки и секции в Ташкенте. Спортивные секции, творческие студии, языковые курсы для детей всех возрастов.',
        },
      }
      
      return seoMap[filters.institution_type_id] || {
        title: 'Каталог детских учреждений в Узбекистане',
        description: 'Полный каталог детских садов, школ, кружков и развивающих центров по всему Узбекистану.',
      }
    }
    
    return {
      title: 'Каталог детских учреждений в Узбекистане',
      description: 'Полный каталог детских садов, школ, кружков и развивающих центров по всему Узбекистану. Сравните цены, услуги и выберите лучшее для вашего ребёнка.',
    }
  }
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl={`https://child-guide.co.uz/institutions${filters.institution_type_id ? `?institution_type_id=${filters.institution_type_id}` : ''}`}
      />
